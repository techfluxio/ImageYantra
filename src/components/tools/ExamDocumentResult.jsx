import { CheckCircle2, Download, RotateCcw, FileText, Users2 } from 'lucide-react';
import { saveBlob, formatBytes } from '../../utils/pdfProcessing.js';

export default function ExamDocumentResult({ items = [], onReset, children }) {
        ...
        <div className="flex flex-col gap-3 border-b border-neutral-100 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-neutral-500">Your documents are ready to download.</div>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="divide-y divide-neutral-100">
          {items.map((item, i) => (
            <div key={i} className="flex items-center gap-4 p-4">
              <div className="grid h-12 w-12 shrink-0 place-items-center rounded-lg bg-neutral-50 ring-1 ring-neutral-200">
